 ...
 * 3. Injects Basic auth and forwards to the real git server
 *
...
export function setupGitProxy(app: Express, credentialStore: CredentialStore): void {
  ...
  app.all("/git-proxy/:proxyKey/:owner/:repoName.git/*", rawParser, async (req: Request, res: Response) => {
